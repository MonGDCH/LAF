 ...
 * Markdown转HTML
 *
 * @example Parser::instance()->makeHtml($markdown) :string
...
class Parser
{
    ...
    private function parseCode(array $lines, array $parts, $start)
    {
        ...
        $str = implode("\n", (array) $this->markLines($lines, $start + 1));
    ...
    private function parsePre(array $lines, $value, $start)
    {
        ...
        $str = implode("\n", (array) $this->markLines($lines, $start));
    ...
    {
        return trim(implode("\n", (array) $this->markLines(array_slice($lines, 1, -1), $start + 1)));
    }
